...
> 💡 **Tip:** The complete plugin list is synced with [`plugins.json`](https://github.com/4wpdev/4wpdev/blob/main/plugins.json). Map notes: [`docs/wordpress-org-plugins.md`](https://github.com/4wpdev/4wpdev/blob/main/docs/wordpress-org-plugins.md).  
...
1. **Explore Plugins**  
   Check out our [`plugins.json`](https://github.com/4wpdev/4wpdev/blob/main/plugins.json) to see all available plugins.
...
For more details, see [SYNC-README.md](https://github.com/4wpdev/4wpdev/blob/main/SYNC-README.md).
